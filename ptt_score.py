...
# 匯入 dcard_food 文章資料
file_name = "db2020_hw5_csv\db2020_ptt_food_score.csv"   # dcard_food 篩出的文章檔案
with open(file=file_name, mode="r", encoding='utf-8') as f:
    ...
    with open(file="ptt_food_sentiment.csv", mode="w", newline="", encoding='utf-8') as f:  # w 表示為覆寫(會刪除原本的)
